...
export default function PriceHR({price_24h}){
    return (
        <>
            {price_24h > 0 && (
                <span className="relative inline-block px-2.5 py-1 ml-2 text-lg sm:text-xl font-semibold text-green-900 leading-tight">
            ...
            {price_24h < 0 && (
                <span className="relative inline-block px-2.5 py-1 ml-2 text-lg sm:text-xl font-semibold text-red-900 leading-tight">
            ...
            {price_24h === 0 && (
                <span className="relative inline-block px-2.5 py-1 ml-2 text-lg sm:text-xl font-semibold text-gray-900 leading-tight">
