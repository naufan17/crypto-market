  ...
  return (
    <div className="relative px-4 py-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-8"> 
      <div className="flex flex-row mb-4 md:mb-8 justify-between">
        <div className="flex">
          <h2 className="max-w-md font-sans text-xl font-bold text-gray-800 sm:text-1xl">
            Aktivitas Market
          </h2>
        </div>
      </div>
        ...
        <tbody className="divide-y divide-slate-200">
          {trade.slice(0, 10).map((item, index) => (
            <tr key={index}>
              ...
              <td className={`px-4 sm:px-6 py-3 sm:py-4 font-semibold font-sans text-sm sm:text-base text-gray-800 ${item.type === 'buy' ? 'text-green-500' : 'text-red-500'}`}>
