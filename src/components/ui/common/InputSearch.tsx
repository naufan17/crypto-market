  ...
  return (
    <div className="relative inline-flex w-full items-center mb-4 sm:mb-0">
      ...
      <input 
        ...
        className="inline-flex w-full sm:h-12 h-10 pl-10 pr-10 sm:text-base text-md text-gray-500 bg-transparent border-2 border-gray-500 rounded-xl appearance-none sm:w-full sm:mr-2.5 sm:mb-0 focus:border-gray-700 focus:outline-none focus:shadow-outline [&::-webkit-search-cancel-button]:appearance-none"
        required
      />
